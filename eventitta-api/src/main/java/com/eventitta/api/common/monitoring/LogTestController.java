...
public class LogTestController {
    ...
    private final ObjectProvider<LogStatusProvider> logMonitorProvider;
    ...
    public ResponseEntity<Map<String, String>> simulateErrors(@RequestParam(defaultValue = "5") int count) {
    ...
    public ResponseEntity<Map<String, String>> getMonitorStatus() {
        ...
        try {
            LogStatusProvider logMonitor = logMonitorProvider.getIfAvailable();
            if (logMonitor != null) {
