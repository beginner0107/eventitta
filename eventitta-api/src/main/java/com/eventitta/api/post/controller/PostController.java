...
public class PostController {
    ...
    public ResponseEntity<PageResponse<PostSummaryResponse>> getPosts(
        ...
        @ParameterObject @Valid PostFilter filter
    ) {
        PageResponse<PostSummaryResponse> result = postService.getPosts(principal != null ? principal.getId() : null, filter);
    ...
    public ResponseEntity<PostDetailResponse> getPost(
        ...
        PostDetailResponse result = postService.getPost(postId, principal != null ? principal.getId() : null);
        return ResponseEntity.ok(result);
    }
    ...
    public ResponseEntity<PostLikeStateResponse> likePost(@PathVariable("postId") Long postId,
                                                          @CurrentUser Long userId) {
        PostLikeStateResponse result = postService.likePost(postId, userId);
        return ResponseEntity.ok(result);
    }
    ...
    public ResponseEntity<PostLikeStateResponse> unlikePost(@PathVariable("postId") Long postId,
                                                            @CurrentUser Long userId) {
        PostLikeStateResponse result = postService.unlikePost(postId, userId);
        return ResponseEntity.ok(result);
    }
