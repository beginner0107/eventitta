...
import com.eventitta.domain.region.dto.response.RegionOptionResponse;
import com.eventitta.domain.region.dto.response.RegionResponse;
...
@TestPropertySource(properties = {
    "spring.datasource.url=jdbc:h2:mem:region_service_db;MODE=MySQL;DB_CLOSE_DELAY=-1;DB_CLOSE_ON_EXIT=FALSE;DATABASE_TO_LOWER=TRUE;DEFAULT_NULL_ORDERING=HIGH;NON_KEYWORDS=VALUE,KEY,USER"
})
