package com.eventitta.domain.gamification.constants;

public final class GamificationErrorCodes {

    private GamificationErrorCodes() {
    }
    ...
    public static final String ACTIVITY_PERSIST_FAILED = "ACTIVITY_PERSIST_FAILED";
}
