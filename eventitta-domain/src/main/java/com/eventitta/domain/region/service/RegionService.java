...
import static com.eventitta.domain.common.constants.CacheConstants.REGION_OPTIONS;
...
public class RegionService {
     ...
     * @throws com.eventitta.domain.region.exception.RegionException 존재하지 않는 지역 코드인 경우
     */
