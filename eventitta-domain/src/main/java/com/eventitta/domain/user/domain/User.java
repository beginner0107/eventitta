...
public class User extends BaseEntity {
    ...
    @Column(name = "profile_picture_media_id")
    ...
    public void setLocalPassword(String encodedPassword) {
        this.password = encodedPassword;
    }

    public void unlinkLegacySocialIdentity() {
    ...
    public void delete() {
        ...
        this.password = null;
        this.providerId = null;
        this.profilePictureMediaId = null;
