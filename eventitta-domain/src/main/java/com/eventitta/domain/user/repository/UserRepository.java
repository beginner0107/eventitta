package com.eventitta.domain.user.repository;
...
public interface UserRepository extends BaseRepository<User, Long> {
    ...
    Optional<User> findAuthUserById(@Param("id") Long id);

    boolean existsByProfilePictureMediaId(Long mediaAssetId);

    long countByDeletedFalse();

    Page<User> findAllByDeletedFalse(Pageable pageable);

    List<User> findAllByIdInAndDeletedFalse(java.util.Collection<Long> ids);
