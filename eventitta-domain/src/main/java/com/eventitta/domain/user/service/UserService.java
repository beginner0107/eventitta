...
import com.eventitta.domain.user.event.UserDeletedEvent;
...
public class UserService {
    ...
    private final UserDeletionMeetingProcessor userDeletionMeetingProcessor;
    ...
    public void deleteUser(Long userId) {
        ...
        userDeletionMeetingProcessor.process(userId);
