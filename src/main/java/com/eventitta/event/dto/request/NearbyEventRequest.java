package com.eventitta.event.dto.request;
...
@Schema(name = "NearbyEventRequest", description = "반경 검색을 위한 요청 파라미터")
public record NearbyEventRequest(
